...
const PLATS = [
  // ── Feculents : c'est la FORME qui tranche en premier, pas la couleur ──
  {
    ...
    famille: "Feculents",
    couleur: "jaune quand il est prepare a l'huile de palme — c'est l'huile qui donne la teinte, pas le grain — et BLANC quand il est prepare sans : les deux existent, la couleur ne suffit donc pas a l'identifier",
    forme: "servi en forme allongee, pas en boule",
    texture: "semoule de manioc, legerement granulee : on distingue le grain",
    accompagnements: "sauces en general, souvent avec du poisson ; accompagne aussi l'eru — deux rouleaux allonges jaunes a cote d'un plat de feuilles vertes sont un couscous de tapioca",
    confusions: [
      { avec: "baton de manioc", signe: "le tapioca est granule (grain visible) et sans ligature ; le baton de manioc est parfaitement lisse et porte des noeuds. La couleur ne tranche pas : le tapioca est jaune a l'huile de palme mais peut etre blanc" },
  ...
  },
  {
    ...
    texture: "LISSE et BRILLANTE, aucun grain visible. Pate de MANIOC, comme le water fufu : les deux sont le meme aliment a la preparation pres, meme famille et memes valeurs nutritionnelles",
    ...
    confusions: [
      ...
      { avec: "water fufu", signe: "distinction sans consequence : tous deux sont du manioc et se valent sur le plan nutritionnel. Ne pas hesiter longuement entre les deux, et ne jamais baisser la confiance pour ce seul motif" },
    ],
    source: "terrain",
  },
  {
  ...
  },
  {
    ...
    forme: "EN BOULE",
    texture: "compacte",
    accompagnements: "sauces diverses ; accompagne aussi l'eru",
    confusions: [
  ...
  },
  {
    ...
    texture: "molle et lisse. Pate de MANIOC, comme le fufu : meme aliment a la preparation pres, memes valeurs nutritionnelles",
    ...
    confusions: [
      ...
      { avec: "fufu", signe: "distinction sans consequence : tous deux sont du manioc et se valent sur le plan nutritionnel. Ne pas hesiter longuement entre les deux" },
  ...
  },
  {
    ...
    accompagnements: "water fufu ou fufu tres souvent, mais aussi couscous de tapioca ou couscous de manioc. Le feculent servi a cote n'est donc pas forcement blanc : deux rouleaux allonges JAUNES a cote de l'eru sont du couscous de tapioca prepare a l'huile de palme, pas du water fufu",
    confusions: [
